...
class LightWindow(ToplevelModal):
    def __init__(self, parent):
        ...
        led_dg_button.set_on_callback(self._parent.controler().led_dg_on)
        led_dg_button.set_off_callback(self._parent.controler().led_dg_off)
        ...
        led_milieu.set_on_callback(self._parent.controler().led_milieu_on)
        led_milieu.set_off_callback(self._parent.controler().led_milieu_off)
